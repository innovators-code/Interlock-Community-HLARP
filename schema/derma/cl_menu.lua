...
function PANEL:Init()
	...
	self.nameLabel:SetFont("InterlockFontShadow30")
	...
	self.factionLabel:SetFont("InterlockFontShadow20")
	...
	self.label:SetFont("InterlockFontShadow30")
	...
	close:SetFont("InterlockFont25-Light")
	...
	local mainmenu = self.buttonsBottom:Add("ixMenuButton")
	mainmenu:SetText("main menu")
	mainmenu:SetSize(250, self.buttonsBottom:GetTall())
	mainmenu:SetFont("InterlockFont25-Light")
	mainmenu:SetContentAlignment(5)
	mainmenu:Dock(LEFT)
...
function PANEL:SetupTab(name, info, sectionParent)
	...
	if (sectionParent) then
		...
		surface.SetFont("InterlockFont20")
		...
		button:SetFont("InterlockFont20")
		button:Dock(RIGHT)
