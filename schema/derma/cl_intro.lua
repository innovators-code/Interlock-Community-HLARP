...
function PANEL:StartIntro()
    ...
    self.name:SetText("Conflict Studios")
    self.name:SetFont("InterlockFontShadow70")
    ...
    self.schema:SetText(Schema.name)
    self.schema:SetFont("InterlockFontShadow40-Light")
...
function PANEL:addContinue()
    ...
    self.info:SetFont("InterlockFontShadow20-Light")
