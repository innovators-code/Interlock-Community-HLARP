...
function PANEL:SetupUI()
    local curReport = ix.ops.CurReport
    ...
    for v,k in pairs(ix.ops.Log) do
    ...
    self.entry:SetFont("ixSmallFont")
    ...
    function self.sendBtn:DoClick()
        ...
        ix_reportMessage = msg

        panel.entry:SetValue("")

        local newID = #ix.ops.Reports + 1
        net.Start("ixChatMessage")
        net.WriteString('/report '..newID..' "'..msg..'"')
        net.SendToServer()
    end
end

vgui.Register("ixUserReportMenu", PANEL, "DFrame")

concommand.Add("ix_userreportmenu", function()
